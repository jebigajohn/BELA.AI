          ...
          {conversations.length === 0 ? (
            ...
            conversations.map((conv) => (
              <button
                ...
                className={`w-full p-4 flex items-start gap-3 hover:bg-neutral-900 transition-colors text-left ${
              ...
              >
                {/* Avatar */}
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center text-white font-semibold flex-shrink-0">
        ...
        {selectedConversation ? (
          <>
            ...
            <div className="p-4 border-t border-neutral-800">
              ...
              <p className="text-xs text-neutral-500 mt-2">
                Enter = Senden | AI-Button = AI generiert Antwort basierend auf
                Kundenanfrage
              </p>
            </div>
          </>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <div className="w-24 h-24 rounded-full border-2 border-neutral-700 flex items-center justify-center mx-auto mb-4">
                <svg
              ...
              <h2 className="text-xl font-semibold mb-2">Deine Nachrichten</h2>
              <p className="text-neutral-500 max-w-sm">
                Wähle eine Konversation aus der Liste oder warte auf neue DMs an
                @23nailroombali
              </p>
            </div>
          </div>
