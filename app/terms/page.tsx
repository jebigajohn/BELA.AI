...
export const metadata = {
  ...
  description:
    'Terms of Service for BELA.AI - Instagram DM Management for 23 Nailroom Bali',
}
  ...
  return (
    <PageWrapper>
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          By interacting with 23 Nailroom Bali through Instagram Direct
          Messages, you agree to these Terms of Service. If you do not agree
          with these terms, please do not use our messaging service.
        </p>

        <h2>2. Service Description</h2>
        <p>
          BELA.AI provides an automated and human-assisted customer service
          system for 23 Nailroom Bali. Our service allows you to:
        </p>
        <ul>
        ...
        <p>
          While you can inquire about appointments through our messaging
          service:
        </p>
        <ul>
        ...
        <p>
          All content, branding, and technology used in BELA.AI and 23 Nailroom
          Bali are protected by intellectual property laws. You may not copy,
          modify, or distribute our content without permission.
        </p>

        <h2>7. Limitation of Liability</h2>
        <p>BELA.AI and 23 Nailroom Bali are not liable for:</p>
        <ul>
        ...
        <p>
          ...
          disputes shall be resolved in the courts of Bali, Indonesia.
        </p>
